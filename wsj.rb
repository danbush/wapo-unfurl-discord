...
initial_search =
  HTTParty.get("https://newsapi.org/v2/everything?apiKey=b63ccdb5b78a4731827f2308ec70018c&sortBy=publishedAt&sources=the-wall-street-journal&q=" + query)

all_articles = initial_search["articles"]

headlines_search = 
HTTParty.get("https://newsapi.org/v2/top-headlines?apiKey=b63ccdb5b78a4731827f2308ec70018c&sortBy=publishedAt&sources=the-wall-street-journal")
